...
class Circle(CRideModel):
    ...
    initation code form an existing circle member
    """
    ...
    verified = models.BooleanField(
        'verified circle',
        default=False,
        help_text='Verified circles are also known as officla communities.'
    )
    ...
    is_limited = models.BooleanField(
        'limited',
        default=False,
        help_text='Limited circles can grow up to a fixed number of numbers'
    )
