...
class Invitation(CRideModel):
    ...
    a uniquecode that grants access to a specific circle.
    This codes are generated by users that are already
    members of the circle and have a 'reamining_invitations'
    value greatear than 0.
    """
    ...
    issued_by = models.ForeignKey(
        ...
        help_text='Cricle member that is providing the invitation',
