# Generated by Django 3.2.14 on 2022-08-02 03:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circles', '0005_alter_circle_is_public'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_by', models.ForeignKey(help_text='Cricle member that is providing the invitation', on_delete=django.db.models.deletion.CASCADE, related_name='issued_by', to=settings.AUTH_USER_MODEL)),
